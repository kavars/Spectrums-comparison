...
@implementation CieCmfXYZSingleton

@synthesize CieCmfXYZArray;

+(CieCmfXYZSingleton *)singleton
{
    static dispatch_once_t pred;
    static CieCmfXYZSingleton *shared = nil;
    
    dispatch_once(&pred, ^{
        shared = [[CieCmfXYZSingleton alloc] init];
        shared.CieCmfXYZArray = [NSArray arrayWithObjects:
